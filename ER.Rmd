...
## Data cleaning
I summarized numbers of missing values in each variable and decided to remove such NAs from dataset.
...
Non-stationary variables would give models large R square and makes estimates unreliable. Original data is time series data, even though I mixed 10 countries' data and deleted observations containing missing values, I still need to check ACF before and avoid using non-stationary variables to fit regressions, here are 2 examples.  
